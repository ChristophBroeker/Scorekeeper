...
angular.module('player.services', ['ngResource'], null)

    .service('PlayerService', function ($resource, $http, $filter) {
        ...
        this.getHistoryForChart = function () {
            ...
            var data = {cols: [
                {'id': 'date', 'label': 'Datum', 'type': 'string'},
                {'id': 'mean', 'label': 'Staerke', 'type': 'number'},
                {'id': 'deviation', 'label': 'Unsicherheit', 'type': 'number'}
            ],
                rows: [
                    {"c": [
                        {"v": ""},
